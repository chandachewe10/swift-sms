...
namespace App\Api\StarterKits\Filament\Resources\ContactMessages;
...
class ContactMessageResourceController extends ResourceController
{
    ...
    {
        return [
            'contact-message' => Presenters\ContactMessages\ContactMessagePresenter::class,
        ];
    }
}
